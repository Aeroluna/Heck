...
internal static class NoodleController
{
    ...
    internal const string V2_PLAYER_TRACK_OBJECT = "_target";
    ...
    internal static CustomJSONDataDeserializer JsonDeserializer { get; } =
        CustomJSONDataDeserializer.Register<FakeNotesJson>();
}
