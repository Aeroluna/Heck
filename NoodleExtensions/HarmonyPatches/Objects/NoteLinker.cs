...
internal class NoteLinker : IAffinity
{
    ...
    {
        if (!_deserializedData.Resolve(noteController.noteData, out NoodleBaseNoteData? baseNoteData) ||
            baseNoteData is not NoodleNoteData noodleData)
        {
            return;
        }
...
#pragma warning disable SA1117
            NoteCutInfo newInfo = new(
                noteController.noteData,
                noteCutInfo.speedOK,
