...
namespace NoodleExtensions.HarmonyPatches.Cutout
{
    ...
    internal static class BaseNoteVisualsAwake
    {
        ...
        private static void Postfix(BaseNoteVisuals __instance, NoteControllerBase ____noteController)
        {
            ...
            DisappearingArrowWrapper wrapper = new(disappearingArrowController, method);
        ...
        private static MethodInfo GetSetArrowTransparency(Type type)
        {
            ...
            Type baseType = type.BaseType ?? throw new InvalidOperationException($"How is this even possible??? {type.FullName}");
