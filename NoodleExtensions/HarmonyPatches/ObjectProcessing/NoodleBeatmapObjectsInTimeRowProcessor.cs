...
{
    private static readonly ConstructorInfo _noodle = AccessTools.FirstConstructor(
        typeof(NoodleBeatmapObjectsInTimeRowProcessor),
        _ => true);

    private static readonly ConstructorInfo _original = AccessTools.FirstConstructor(
        typeof(BeatmapObjectsInTimeRowProcessor),
        _ => true);
    ...
    {
        return processor is NoodleBeatmapObjectsInTimeRowProcessor
                   { BeatmapData: CustomBeatmapData and IVersionable versionable } &&
