...
{
    private static readonly MethodInfo _eulerAnglesSetter =
        AccessTools.PropertySetter(typeof(Transform), nameof(Transform.eulerAngles));

    private static readonly MethodInfo _localEulerAnglesSetter =
        AccessTools.PropertySetter(typeof(Transform), nameof(Transform.localEulerAngles));
