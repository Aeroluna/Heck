...
internal class FakeNotePatches : IAffinity
{
        ...
        [InjectOptional] NoteCutCoreEffectsSpawner? noteCutCoreEffectsSpawner)
    {
        ...
        _noteCutCoreEffectsSpawner = context != null
            ? context.GetComponentInChildren<NoteCutCoreEffectsSpawner>()
    ...
    [AffinityPatch(
        typeof(NoteCutSoundEffectManager),
        nameof(NoteCutSoundEffectManager.HandleNoteWasSpawned))] // Do not create a NoteCutSoundEffect for fake notes
