...
public class ObstacleColorizerManager
{
    ...
    public void Colorize(ObstacleControllerBase obstactleController, Color? color)
    {
        GetColorizer(obstactleController).Colorize(color);
    }

    public ObstacleColorizer GetColorizer(ObstacleControllerBase obstactleController)
    {
        return Colorizers[obstactleController];
    }
    ...
    internal override void Refresh()
    {
        ...
        foreach (MaterialPropertyBlockController materialPropertyBlockController in _materialPropertyBlockControllers)
        {
            ...
            materialPropertyBlockController.materialPropertyBlock.SetColor(
                _tintColorID,
                Color.Lerp(color, Color.white, _obstacleCoreLerpToWhiteFactor));
