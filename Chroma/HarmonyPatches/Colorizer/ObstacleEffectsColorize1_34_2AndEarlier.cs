...
{
    private static readonly FieldInfo _effectsField =
        AccessTools.Field(
            typeof(ObstacleSaberSparkleEffectManager),
            nameof(ObstacleSaberSparkleEffectManager._effects));

    private static readonly MethodInfo _setPositionAndRotation =
        AccessTools.Method(
            typeof(ObstacleSaberSparkleEffect),
            nameof(ObstacleSaberSparkleEffect.SetPositionAndRotation));
    ...
    private ObstacleEffectsColorize(ObstacleColorizerManager manager)
    {
        ...
        _setObstacleSparksColor =
            InstanceTranspilers.EmitInstanceDelegate<Action<ObstacleSaberSparkleEffect, ObstacleController>>(
                SetObstacleSaberSparkleColor);
    }
    ...
    private void SetObstacleSaberSparkleColor(
        ObstacleSaberSparkleEffect obstacleSaberSparkleEffect,
