...
internal class MovementBeatmapChromafier : IAffinity
{
        ...
        float ____transitionSpeed)
    {
        ...
        {
            Vector3 dir = (____movementData[1].localPositionOffset - ____movementData[0].localPositionOffset)
                .normalized;
        ...
        float speed = customAvail && chromaEventData!.Speed.HasValue
            ? chromaEventData.Speed.Value
            : ____transitionSpeed;

        ____prevPositionOffset = ____currentPositionOffset;
        ____currentPositionOffset = Vector3.LerpUnclamped(
            ____currentPositionOffset,
            finalPos,
