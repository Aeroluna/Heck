    ...
    public override Color GetValue(float time)
    {
        ...
        switch (LerpType)
        {
            ...
            case LerpType.HSV:
                ...
                return Color
                    .HSVToRGB(
                        Mathf.LerpUnclamped(fromH, toH, time),
                        Mathf.LerpUnclamped(fromS, toS, time),
                        Mathf.LerpUnclamped(fromV, toV, time))
                    .ColorWithAlpha(Mathf.LerpUnclamped(fromValue.a, toValue.a, time));
