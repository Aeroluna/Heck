...
[Module(ID, 3, LoadType.Active, ["ChromaColorizer", "ChromaEnvironment"])]
...
#else
        bool legacyOverride =
            difficultyBeatmap is CustomDifficultyBeatmap { beatmapSaveData: Version3CustomBeatmapSaveData customBeatmapSaveData } &&
