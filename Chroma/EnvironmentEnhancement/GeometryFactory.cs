...
internal class GeometryFactory
{
    ...
    private TubeBloomPrePassLight? _originalTubeBloomPrePassLight =
        Resources.FindObjectsOfTypeAll<TubeBloomPrePassLight>().FirstOrDefault();
    ...
    internal GameObject Create(CustomData customData, bool v2)
    {
        GeometryType geometryType =
            customData.GetStringToEnumRequired<GeometryType>(v2 ? V2_GEOMETRY_TYPE : GEOMETRY_TYPE);
