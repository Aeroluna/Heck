...
{
    internal Features(
        bool useChromaEvents,
        EnvironmentEffectsFilterPreset? forcedPreset,
    ...
    {
        public override Features ReadJson(
            JsonReader reader,
            Type objectType,
            Features existingValue,
            ...
            JsonSerializer serializer)
        {
            ...
            List<Version3CustomBeatmapSaveData.BasicEventSaveData>? basicEventDatas = basicBeatmapEvents.Count > 0
                ? basicBeatmapEvents.Cast<Version3CustomBeatmapSaveData.BasicEventSaveData>().ToList()
                : null;
            return new Features(
                useChromaEvents,
                forcedPreset,
