...
public static class AnimationExtensions
{
    ...
    [Pure]
    public static Track? GetNullableTrack(
    ...
    [Pure]
    public static IEnumerable<Track>? GetNullableTrackArray(
        this CustomData customData,
        Dictionary<string, Track> beatmapTracks,
        bool v2)
    {
    ...
    [Pure]
    public static PointDefinition<T>? GetPointData<T>(
        this CustomData customData,
        string pointName,
        ...
        switch (pointString)
        {
            ...
            default:
                throw new InvalidOperationException(
                    $"Point was not a valid type. Got [{pointString.GetType().FullName}].");
        }
    }
