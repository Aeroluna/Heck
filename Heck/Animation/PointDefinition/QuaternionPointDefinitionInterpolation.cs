...
namespace Heck.Animation
{
    ...
    {
        protected override Quaternion InterpolatePoints(PointDefinition<Quaternion> previousPoint, PointDefinition<Quaternion> basePoint, float interpolation, float time)
        {
