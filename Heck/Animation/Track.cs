...
public class Track
{
    ...
    {
        return _aliases.TryGetValue(name, out List<string> aliases)
            ? aliases
    ...
    {
        return _pathAliases.TryGetValue(name, out List<string> aliases)
            ? aliases
    ...
    {
        return _registeredPathProperties.TryGetValue(name, out IPropertyBuilder propertyBuilder)
            ? propertyBuilder
            : null;
    }
