...
{
    private static readonly FieldInfo _followedObstacleField = AccessTools.Field(
        typeof(MirroredObstacleController),
        "_followedObstacle");

    private static readonly MethodInfo _removeListeners = AccessTools.Method(
        typeof(MirroredObstacleController),
        nameof(MirroredObstacleController.RemoveListeners));
