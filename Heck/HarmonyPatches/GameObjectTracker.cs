...
namespace Heck.HarmonyPatches
{
    ...
    internal class GameObjectTracker : IAffinity, IDisposable
    {
            ...
            BeatmapObjectManager beatmapObjectManager)
        {
            ...
            _despawnMirroredObject = InstanceTranspilers.EmitInstanceDelegate<Func<MonoBehaviour, MonoBehaviour>>(DespawnMirroredObject);
        }
        ...
        [AffinityPatch(typeof(MirroredBeatmapObjectManager), nameof(MirroredBeatmapObjectManager.HandleObstacleWasDespawned))]
        ...
        private IEnumerable<CodeInstruction> ReplaceConditionTranspiler(IEnumerable<CodeInstruction> instructions)
        {
            return new CodeMatcher(instructions)
                 ...
                 */
                .MatchForward(false, new CodeMatch(n => n.opcode == OpCodes.Callvirt && ((MethodInfo)n.operand).Name == "Despawn"))
                .Repeat(n => n
