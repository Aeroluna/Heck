...
namespace Heck.HarmonyPatches.UntransformedData
{
    ...
    public class HeckGameplayCoreSceneSetupData : GameplayCoreSceneSetupData
    {
        ...
        private static readonly FieldAccessor<GameplayCoreSceneSetupData, BeatmapLevelsModel>.Accessor _beatmapLevelsModelAccessor =
        ...
        private static void OverrideGetTransformedBeatmapDataAsync(GameplayCoreSceneSetupData __instance, IReadonlyBeatmapData beatmapData)
        {
