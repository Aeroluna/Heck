...
#pragma warning restore 8618
    ...
    public void Reload(IDifficultyBeatmap difficultyBeatmap)
    {
        ...
        BeatmapCharacteristicSO levelCharacteristic =
            customDifficultyBeatmap.parentDifficultyBeatmapSet.beatmapCharacteristic;
        StandardLevelInfoSaveData.DifficultyBeatmap standardLevelInfoSaveDataDifficultyBeatmap =
            standardLevelInfoSaveData
                .difficultyBeatmapSets.First(
                    x => x.beatmapCharacteristicName == levelCharacteristic.serializedName)
                .difficultyBeatmaps.First(
